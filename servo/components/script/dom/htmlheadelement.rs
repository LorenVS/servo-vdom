...
impl HTMLHeadElement {
    fn new_inherited(id: u64,
        ...
        HTMLHeadElement {
            htmlelement: HTMLElement::new_inherited(HTMLElementTypeId::HTMLHeadElement, id, localName, prefix, document)
        }
    }
    ...
    pub fn new(id: u64,
        ...
        let element = HTMLHeadElement::new_inherited(id, localName, prefix, document);
