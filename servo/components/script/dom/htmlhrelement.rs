...
impl HTMLHRElement {
    fn new_inherited(id: u64, localName: Atom, prefix: Option<DOMString>, document: &Document) -> HTMLHRElement {
        HTMLHRElement {
            htmlelement: HTMLElement::new_inherited(HTMLElementTypeId::HTMLHRElement, id, localName, prefix, document)
        }
    }
    ...
    pub fn new(id: u64,
        ...
        let element = HTMLHRElement::new_inherited(id, localName, prefix, document);
